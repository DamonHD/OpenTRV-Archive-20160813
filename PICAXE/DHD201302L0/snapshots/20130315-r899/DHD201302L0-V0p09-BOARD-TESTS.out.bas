...
; Should be pulled up externally so can be inputs or high outputs (to avoid floating).
;high B.1
...
; I/O setup/initialisation prologue should leave board safe.


#define USE_MODULE_DIAGTOOLS
