...
; IF DEFINED: this unit may run on 2xAA cells, preferably rechargeable eg NiMH, ~2V--2.4V, so may need to monitor supply voltage with calibadc.
...
symbol FHT8V_HC1 = 45 ; 13 ; House code 1, constant or (byte) register.
symbol FHT8V_HC2 = 26 ; 73 ; House code 2, constant or (byte) register.
