...
symbol BOILER_CALL_TIMEOUT_S = 120 ; Time in seconds from last call for heat to boiler going off.  Each node should broadcast at least once per minute.
#endif
...
#ifdef BOILER_HUB ; Listen for TRV nodes calling for heat.
