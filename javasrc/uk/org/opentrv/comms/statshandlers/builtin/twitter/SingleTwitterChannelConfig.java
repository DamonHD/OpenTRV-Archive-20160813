...
public final class SingleTwitterChannelConfig
     ...
     * Preferably prime or otherwise set to allow tweets to roll at different times
     * through the hour to help avoid deadly embraces with other traffic, for example.
     */
    public static final int DEFAULT_MINIMUM_MESSAGE_INTERVAL_M = 61;
    ...
    /**Create with a given map config.*/
    public SingleTwitterChannelConfig(final Map config)
        {
        this(getAsString(config, "hexID"));
        }
